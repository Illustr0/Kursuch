...
class DishIngredientsControllerTest < ActionController::TestCase
  ...
  test "should create dish_ingredient" do
    assert_difference('DishIngredient.count') do
      post :create, dish_ingredient: { dish_id: @dish_ingredient.dish_id, how_many: @dish_ingredient.how_many, ingredient_id: @dish_ingredient.ingredient_id, measure: @dish_ingredient.measure }
    end
  ...
  test "should update dish_ingredient" do
    patch :update, id: @dish_ingredient, dish_ingredient: { dish_id: @dish_ingredient.dish_id, how_many: @dish_ingredient.how_many, ingredient_id: @dish_ingredient.ingredient_id, measure: @dish_ingredient.measure }
    assert_redirected_to dish_ingredient_path(assigns(:dish_ingredient))
  end
